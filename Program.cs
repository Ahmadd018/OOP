...
namespace task2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Fisher fisher = new Fisher("Mehemmed", 10, FisherSpecialty.Fishing);
            BusinessAnalyst businessAnalyst = new BusinessAnalyst("Ahmed", 12, BusinessAnalystTeam.Income);

            fishingDepartment.Hire(fisher);
            businessDepartment.Hire(businessAnalyst);

            fisher.Work(8);
            businessAnalyst.Work(8);
